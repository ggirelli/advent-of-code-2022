...
fn test_parse_starting_item_values() {
    assert_eq!(
        _parse_starting_item_values("  Starting items: 79, 98"),
        [79, 98].to_vec()
    );
    assert_eq!(
        _parse_starting_item_values("  Starting items: 54, 65, 75, 74"),
        [54, 65, 75, 74].to_vec()
    );
    assert_eq!(
        _parse_starting_item_values("  Starting items: 79, 60, 97"),
        [79, 60, 97].to_vec()
    );
    assert_eq!(
        _parse_starting_item_values("  Starting items: 74"),
        [74].to_vec()
    );
}
